"""Doubao (豆包) LLM client implementation.

This client uses OpenAI-compatible API format for Doubao models
hosted on Volcano Engine (火山引擎).
"""
...
class DoubaoClient(LLMClientBase):
    """LLM client for Doubao models on Volcano Engine.

    This client uses the OpenAI SDK to interact with Doubao's OpenAI-compatible API.
    It supports:
    - Tool calling
    ...
    def __init__(
        ...
        Args:
            api_key: API key for Volcano Engine authentication
            api_base: Base URL for Doubao API (default: Volcano Engine endpoint)
            model: Model name to use (e.g., "doubao-pro-32k", "doubao-pro-128k")
    ...
    def _prepare_request(
        ...
        """Prepare the request for Doubao API.
    ...
    def _parse_response(self, response: Any) -> LLMResponse:
        """Parse Doubao response into LLMResponse.
        ...
        return LLMResponse(
            ...
            thinking=None,  # Doubao doesn't support reasoning/interleaved thinking yet
            tool_calls=tool_calls if tool_calls else None,
            finish_reason="stop",  # Doubao compatibility
            usage=usage,
        )
    ...
    async def generate(
        ...
        """Generate response from Doubao LLM.
